if __name__ == "__main__":
    ...
    p.add_argument('--face-type', dest="face_type", choices=['half_face', 'full_face', 'whole_face', 'head', 'mark_only'], default='whole_face')
    p.add_argument('--max-faces-from-image', type=int, dest="max_faces_from_image", default=None, help="Max faces from image.")
    p.add_argument('--image-size', type=int, dest="image_size", default=2048, help="Output image size.")
    p.add_argument('--jpeg-quality', type=int, dest="jpeg_quality", default=100, help="Jpeg quality.")
